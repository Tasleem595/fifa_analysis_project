...
background:linear-gradient(180deg,#02050d 0%,#08101e 40%,#0c1426 100%)!important;
...
background:linear-gradient(135deg,rgba(0,212,255,.18),rgba(124,58,237,.18))!important;
border:1px solid rgba(0,212,255,.25)!important;
box-shadow:0 0 12px rgba(0,212,255,.12)!important;
}
