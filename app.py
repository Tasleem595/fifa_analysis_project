...
[data-testid="stSidebar"]{background:linear-gradient(180deg,#040710,#08101e)!important;border-right:1px solid var(--border)!important;}
...
def fig_style(fig, title=None, h=400):
    fig.update_layout(
        ...
        title_text=title, title_font=dict(family="Exo 2", size=14, color="#e2e8f0"),
...
with st.sidebar:
    ...
    <div style="text-align:center;padding:1rem 0 .8rem">
      ...
      <div style="font-family:'Exo 2',sans-serif;font-size:1.2rem;font-weight:800;color:#00d4ff">FIFA 22</div>
      <div style="font-family:'Space Mono',monospace;font-size:.62rem;color:#64748b;letter-spacing:.15em">PLAYER ANALYTICS</div>
    </div>
    """, unsafe_allow_html=True)
    st.divider()
