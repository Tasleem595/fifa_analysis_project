...
[data-testid="stSidebar"] .stRadio label:hover{
    background:linear-gradient(135deg,rgba(0,212,255,.15),rgba(124,58,237,.12))!important;
    transform:translateX(3px)!important;
    border:1px solid rgba(0,212,255,.25)!important;
    box-shadow:0 0 15px rgba(0,212,255,.1)!important;
}

[data-testid="stSidebar"] .stRadio [aria-checked="true"]{
    background:linear-gradient(135deg,rgba(0,212,255,.25),rgba(124,58,237,.2))!important;
...
with st.sidebar:
    ...
    <div class="sidebar-header">
      ...
      <h1 class="title">FIFA 22</h1>
      <p class="subtitle">Player Analytics</p>
    </div>
    """, unsafe_allow_html=True)
    ...
    <div class="sidebar-footer">
      ...
      FIFA 22 · SoFIFA<br>
      <span style="font-size:.62rem;color:#475569;margin-top:.4rem;display:block;">
